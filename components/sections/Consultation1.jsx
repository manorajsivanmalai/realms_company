                        ...
                        <div className="col-lg-7">
                            <div className="consultation-content">
                                <div className="section-title mb-25">
                                    ...
                                    <h2 className="title">Let’s Cook Up Some Magic!</h2>
                                </div>
                                <p>Share your details below and grab a Free Consultation—no hidden terms, just genuine help, pakka promise! </p>
